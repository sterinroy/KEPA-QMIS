...
const PurchaseTransfer = () => {
  ...
  return (
    <div className="purchase-transfer-container">

      <main className="purchase-transfer-main">
          <Box
            sx={{
              flexGrow: 1,
              display: "flex",
          ...
          >
            <Box sx={{ px: 2, py: 2, borderBottom: 1, borderColor: "#2C2F57" }}>
              <Typography variant="h6" fontWeight="bold" sx={{ color: "white",fontSize: { xs: "1rem", sm: "1.25rem" } }}>
                Recent Transfers
              </Typography>
            </Box>
